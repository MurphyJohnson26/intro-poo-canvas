...
// Círculo en el centro del canvasOOP
...
// Círculo aleatorio dentro del canvasRandom
...
// Múltiples círculos dentro del canvasMultiple
let arrayCircle = [];

for (let i = 0; i < 10; i++) {
  let randomRadius = Math.floor(Math.random() * 10 + 10);
